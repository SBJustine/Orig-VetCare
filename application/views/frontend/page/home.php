<main> 
       <!--? Slider Area Start-->
<div class="slider-area" style="background-image: url('<?php echo base_url();?>assets/img1/gallery/h1_hero.png'); background-size: cover; background-repeat: no-repeat; background-position: center;">
                    ...
                    <div class="col-lg-8">
                        <div class="contact_text text-center">
                            ...
                            <div class="contact_btn d-flex align-items-center justify-content-center">
                                <a href="<?= base_url();?>index.php/contact" class="btn white-btn">Contact Us</a>
                                <p>Or<a href="#"> 09959401818 </a></p>
                            </div>
                        </div>
                    </div>
                </div>
