...
<div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light" >
                ...
                <a href="<?= base_url();?>index.php/petOwner" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Pet Info</a> 
                ...
                <!-- <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-transparent border-0">
                        <a href="<?= base_url();?>index.php/payment"  class="dropdown-item">Payment Form</a>
                        <a href="<?= base_url();?>index.php/payment_table"  class="dropdown-item">Payments</a>
                    </div>
                </div> -->
